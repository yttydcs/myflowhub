...
- `2026-03-28`：`MyFlowHub-Win` 已把 `Permit Issuance` 页在 remote authority 场景下收敛为 authority-local 限制提示，并在 Win orchestration 层对 permit 管理动作做快速失败，不再继续暴露 `auth list_register_permits: request timed out` 作为普通加载失败；详见 `docs/change/2026-03-28_win-permit-remote-authority-guard.md`、`docs/plan/plan_archive_2026-03-28_win-permit-remote-authority-guard.md` 与 `docs/lessons/authority-local-admin-actions.md`。
...
- `win-permit-remote-authority-guard` 已完成归档：详见 `docs/change/2026-03-28_win-permit-remote-authority-guard.md`、`docs/plan/plan_archive_2026-03-28_win-permit-remote-authority-guard.md` 与 `docs/lessons/authority-local-admin-actions.md`。
...
- `win-project-meta-uuid` 已完成归档：详见 `docs/change/2026-03-27_win-project-meta-uuid.md` 与 `docs/plan/plan_archive_2026-03-27_win-project-meta-uuid.md`。
...
- `Win 准入许可页 remote authority 超时收敛` workflow 计划归档：`docs/plan/plan_archive_2026-03-28_win-permit-remote-authority-guard.md`
- `Win 准入许可页 remote authority 超时收敛` 变更归档：`docs/change/2026-03-28_win-permit-remote-authority-guard.md`
- `Authority local admin actions` lesson：`docs/lessons/authority-local-admin-actions.md`
...
- `Win Flow 项目默认 UUID 收敛` workflow 计划归档：`docs/plan/plan_archive_2026-03-27_win-project-meta-uuid.md`
- `Win Flow 项目默认 UUID 收敛` 变更归档：`docs/change/2026-03-27_win-project-meta-uuid.md`
