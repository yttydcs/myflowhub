...
// 本文件承载 Core 框架中与 `bluez_linux` 相关的通用逻辑。
...
func dialRFCOMMByUUIDBlueZ(ctx context.Context, opts DialOptions) (link.Pipe, error) {
...
type bluezProfileConfig struct {
	...
	addrRole        string
	singleShot      bool
	wrapPipe        func(*os.File) link.Pipe
}
...
func (l *linuxBluezListener) Accept() (link.Pipe, net.Addr, net.Addr, error) {
	select {
