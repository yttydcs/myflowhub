...
Pure-Python bounded MFH4 v2 leaf client. Platform code supplies a transport with `connect/read_exact/write_all/close` and a crypto provider with `generate_key/random/sign/verify`.
