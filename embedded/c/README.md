...
C99 bounded leaf/client profile for the MFH4 v2 envelope. The library performs no allocation: callers own frame buffers, identity storage, transport I/O, randomness, Ed25519 signing, and join-ack verification.
