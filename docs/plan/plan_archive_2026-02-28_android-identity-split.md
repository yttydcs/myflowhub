...
- **涉及文件**
  - `repo/MyFlowHub-Android/app/src/main/java/com/myflowhub/android/Prefs.kt`
  - （如需要）新增 `repo/MyFlowHub-Android/app/src/main/java/com/myflowhub/android/Identity.kt`
- **验收条件**
...
- **涉及文件**
  - `repo/MyFlowHub-Android/app/src/main/java/com/myflowhub/android/ui/AppRoot.kt`
- **验收条件**
...
- **涉及文件**
  - `repo/MyFlowHub-Android/app/src/main/java/com/myflowhub/android/ui/LoginScreen.kt`
  - `repo/MyFlowHub-Android/app/src/main/java/com/myflowhub/android/ui/HubScreen.kt`
- **验收条件**
...
- **涉及文件**
  - `repo/MyFlowHub-Android/app/src/main/java/com/myflowhub/android/GoClientBridge.kt`
  - `repo/MyFlowHub-Android/app/src/main/java/com/myflowhub/android/ui/LoginScreen.kt`
- **验收条件**
