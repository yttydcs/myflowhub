...
> 归档说明：本计划记录 `refactor/resource-platform-desktop-workspace` 从讨论、计划、执行到重测收敛的完整过程。当前主线状态请回到 [`../../plan.md`](../../plan.md)；本文件不再作为活跃任务入口。
...
- Primary sources 已记录在 [discussion intake](../intake/2026-08-28_extensible-resources-and-desktop-workspace-redesign.md)。
...
- 以 [可扩展资源平台需求](../requirements/extensible-resource-platform.md) 与 [Desktop 工作区需求](../requirements/desktop-resource-workspace.md) 为准。
...
- Intake: [extensible resources and Desktop redesign](../intake/2026-08-28_extensible-resources-and-desktop-workspace-redesign.md)
- Features: [Desktop](../features/desktop.md), [File transfer](../features/file-transfer.md)
- Requirements: [extensible resource platform](../requirements/extensible-resource-platform.md), [Desktop resource workspace](../requirements/desktop-resource-workspace.md), [unified node runtime](../requirements/unified-node-runtime.md), [auth admission](../requirements/auth-controlled-admission.md)
- Specs: [node-tree architecture](../specs/node-tree-link-resource-architecture.md), [resource model vNext](../specs/resource-model-vnext.md), [subscription vNext](../specs/subscription-vnext.md), [file transfer](../specs/file-transfer-vnext.md)
- Decisions: [extensible resource type and Desktop workspace](../decisions/2026-08-28_extensible-resource-type-system-and-desktop-workspace.md), [authoritative node tree](../decisions/2026-08-27_authoritative-node-tree-and-pluggable-links.md)
