...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-11_subproto-resp-msgid.md`
...
- 原 plan（归档）：
  - `docs/plan/plan_archive_2026-03-08_subproto-auth-route-index-heal.md`
  - `docs/plan/plan_archive_2026-03-08_server-auth-route-index-heal.md`
- 归档（全局）：
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-07_metricsnode-ci-fix.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-04_win-showcase-canvas-layout.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-04_win-file-console-base-dir.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-04_subproto-file-base-dir-exedir-root-list.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-04_server-bump-subproto-file-v0.1.1.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-03_subproto-management-children-only.md`
...
- 变更：
  - `docs/specs/protocol_map.md`：在 Manual Notes 补充 Nodes 语义（children-only / list_subtree=direct+self / has_children 为 hint）。
- 验收：`GOWORK=off go test ./... -count=1 -p 1`
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-03_proto-management-children-only.md`
...
- 验收：`GOWORK=off go test ./... -count=1 -p 1`
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-03_server-bump-management-v0.1.2.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-03_android-bump-management-v0.1.2.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-03_android-release-v0.1.12.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-03_android-topicbus.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-03_win-showcase-layout.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-03_win-varpool-dialog-subprefs.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-03_win-showcase-panel-simplify.md`
...
- 验收：
  - Go：`GOWORK=off go test ./... -count=1`
  - Win：`GOWORK=off wails build -debug -skipembedcreate -nopackage`
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-03_win-showcase-kv-layout.md`
...
- 验收：
  - Go：`GOWORK=off go test ./... -count=1 -p 1`
  - Win 前端：`cd frontend; npm ci; GOWORK=off wails generate module; npm run build`
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-03_win-varpool-refresh-subscribe-ui.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-03_metricsnode-settings-ui.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-03_metricsnode-ui-polish.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-03_metricsnode-ci-build.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-02_win-showcase-screen.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-02_android-debug-direct-apk.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-02_metricsnode-brightness-control.md`
...
- 验收：
  - Android：`./gradlew :app:assembleDebug`
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-02_android-nav-icons.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-02_metricsnode-brightness-deviceid.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-02_metricsnode-win-brightness-wmi.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-02_metricsnode-win-brightness-wmi-set.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-01_metricsnode-var-control.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-01_metricsnode-windows-ignore-config.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-01_metricsnode-deps-upgrade.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-01_android-varstore.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-01_win-varpool-liveupdate.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-03-01_win-release-tag-validate.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-28_win-actions-release.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-28_metricsnode-mvp.md`
...
- 验收：
  - Android：`./gradlew :app:assembleDebug`
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-28_android-ui-devices-kv-editor.md`
...
- 验收：
  - Android：`./gradlew :app:assembleDebug`
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-28_android-devices-dialog.md`
...
- 验收：
  - Android：`./gradlew :app:assembleDebug`
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-28_android-identity-split.md`
...
- 验收：
  - Android：`./gradlew :app:assembleDebug`
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-27_android-ui-chrome-scroll.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-27_android-ui-drawer-snackbar.md`
...
- 验收：
  - Android：`./gradlew :app:assembleDebug`
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-27_android-ui-polish-snackbar.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-27_android-fgs-type-gomobile-reflect.md`
...
- 验收：
  ...
  - Android：`./gradlew :app:assembleDebug`
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-27_android-hub-ui-v1.md`
...
- 原 plan（归档）：
  - `docs/plan/plan_archive_2026-02-25_android-hub-m0_server.md`
  - `docs/plan/plan_archive_2026-02-25_android-hub-m0_android.md`
- 归档（全局）：
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-25_android-hub-m0-smoke_android.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-24_win-self-config.md`
...
- 验收：
  - `GOWORK=off wails build -nopackage`
  - `frontend/`：`npm run build`
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-24_win-ui-polish.md`
...
- 验收：
  - `GOWORK=off wails build -nopackage`
  - `frontend/`：`npm run build`
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-24_win-devices-config.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-24_win-overlay-mask.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-24_devices-node-info.md`
...
- 验收：
  - `GOWORK=off go test ./...`
  - `GOWORK=off wails build -nopackage`
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-23_win-ui-toast.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-22_win-localhub.md`
...
- 文件：
  ...
  - 原 plan（归档）：`docs/plan/plan_archive_2026-02-21_dev-run-server-win.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-21_win-session-devices.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-21_win-devices-tree.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-21_win-devices-tree-expand.md`
...
- 验收：
  ...
  - `GOWORK=off wails build -nopackage`
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-21_win-flow-dag-editor-pr2.md`
...
- 验收：
  - `GOWORK=off go test ./... -count=1 -p 1`
  - `GOWORK=off wails build -nopackage`
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-21_win-flow-dag-editor-pr1.md`
...
- 目标：
  ...
  - 新增 canonical 文档 `repo/MyFlowHub-Proto/docs/specs/protocol_map.md`（半自动：仅替换生成区块）
  - 新增生成器：`go run ./cmd/protocolmapgen -write|-check -out docs/specs/protocol_map.md`
  - Proto 仓内 `go test ./...` 强制校验文档与协议定义一致（门禁）
- 验收：
  - `GOWORK=off go test ./... -count=1 -p 1`
  - `GOWORK=off go run ./cmd/protocolmapgen -check -out docs/specs/protocol_map.md`
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-20_proto-protocol-mapgen.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-20_subproto-split-remaining-modules.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-20_server-use-subproto-remaining-modules.md`
...
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-19_win-services-converge.md`
...
- 验收：
  ...
  - `GOWORK=off wails generate module`
  - `cd frontend && npm ci && npm run build`
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-18_win-mgmt-service.md`
...
- 文档变更：
  ...
  - `docs/specs/protocol_map.md`：协议模型来源改为 `myflowhub-proto/protocol/*`。
- 原 plan（归档）：`docs/plan/plan_archive_2026-02-18_docs-consistency.md`
- Repos（已合并并 push）：
...
- Workflow plan（归档）：`docs/plan/plan_archive_2026-03-05_metricsnode-connect-settings-compact.md`
...
2) 行为对齐 `repo/MyFlowHub-Server/docs/specs/varstore.md` 的规范：`list` 请求应发送到“当前连接的 Hub/目标节点”（默认 hubId），而不是直发到 owner 节点。
...
- [x] 归档：
  ...
  - 计划归档：`docs/plan/plan_archive_2026-03-12_transport-pipe-*.md`
...
- 计划归档：
  - `docs/plan/plan_archive_2026-03-12_bump-core-v0.3.0-server-prev.md`
  - `docs/plan/plan_archive_2026-03-12_bump-core-v0.3.0-subproto-prev.md`
...
- 已执行：`git mv plan.md docs/plan/plan_archive_2026-03-12_bump-core-v0.3.0-subproto-prev.md`
...
- 计划归档：
  - `docs/plan/plan_archive_2026-03-12_bump-core-v0.3.0-subproto-more-prev.md`
  - `docs/plan/plan_archive_2026-03-12_bump-core-v0.3.0-android-hubmobile-prev.md`
- 结论：两仓 `GOWORK=off go test` 均通过；已合并并 push 到各自 `main`。
...
- 已执行：`git mv plan.md docs/plan/plan_archive_2026-03-12_bump-core-v0.3.0-subproto-more-prev.md`
...
- 已执行：`git mv plan.md docs/plan/plan_archive_2026-03-12_bump-core-v0.3.0-android-hubmobile-prev.md`
...
- 计划归档：
  - `docs/plan/plan_archive_2026-03-14_bump-core-v0.4.0-remaining.md`
- 分仓结果：
...
- 计划归档：
  - `docs/plan/plan_archive_2026-03-14_cleanup-residual-worktrees.md`
- 主要结果：
  - 已删除残留 git worktree：
...
- 原 plan（归档）：
  - `docs/plan/plan_archive_2026-03-18_win-dag-nodeid-icons.md`
